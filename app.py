...
def authenticate_gee():
    try:
        if "GEE_JSON_B64" in st.secrets:
            # 1. Recuperar la cadena y limpiar espacios o comillas accidentales
            b64_str = st.secrets["GEE_JSON_B64"].strip().strip('"').strip("'")
            
            # 2. FIX DE PADDING: Asegura que la longitud sea múltiplo de 4
            ...
            # ... resto de la lógica para inicializar ee ...
